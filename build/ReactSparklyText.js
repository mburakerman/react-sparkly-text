...
// src/components/ReactSparklyText/ReactSparklyText.tsx
...
var Ve = new Re();
var Fe = xe();
var Me = o.createContext({ shouldForwardProp: void 0, styleSheet: Ve, stylis: Fe });
var ze = Me.Consumer;
...
function Le(e) {
  var t = s(e.stylisPlugins), n = t[0], r2 = t[1], c2 = Be().styleSheet, l2 = i(function() {
    var t2 = c2;
  ...
  return o.createElement(Me.Provider, { value: d }, o.createElement($e.Provider, { value: u2 }, e.children));
}
var Ge = function() {
  function e(e2, t) {
    var n = this;
...
var He = function(t) {
  ...
  for (var s2 in t) {
    var i2 = t[s2];
    t.hasOwnProperty(s2) && !We(i2) && (Array.isArray(i2) && i2.isCss || re(i2) ? r2.push("".concat(qe(s2), ":"), i2, ";") : ce(i2) ? r2.push.apply(r2, __spreadArray(__spreadArray(["".concat(s2, " {")], He(i2), false), ["}"], false)) : r2.push("".concat(qe(s2), ": ").concat((n = s2, null == (o2 = i2) || "boolean" == typeof o2 || "" === o2 ? "" : "number" != typeof o2 || 0 === o2 || n in emotion_unitless_esm_default || n.startsWith("--") ? String(o2).trim() : "".concat(o2, "px")), ";")));
  }
  return r2;
};
...
function rt(e, r2, s2) {
  ...
  function O2(e2, r3) {
    return function(e3, r4, s3) {
      var i3 = e3.attrs, a3 = e3.componentStyle, c3 = e3.defaultProps, p3 = e3.foldedComponentIds, d2 = e3.styledComponentId, h2 = e3.target, f3 = o.useContext(Ke), m3 = Be(), y3 = e3.shouldForwardProp || m3.shouldForwardProp;
      ...
      for (var w3 in v2)
        void 0 === v2[w3] || "$" === w3[0] || "as" === w3 || "theme" === w3 || ("forwardedAs" === w3 ? S3.as = v2.forwardedAs : y3 && !y3(w3, g3) || (S3[w3] = v2[w3], y3 || "development" !== process.env.NODE_ENV || isPropValid(w3) || ot.has(w3) || !A.has(g3) || (ot.add(w3), console.warn('styled-components: it looks like an unknown prop "'.concat(w3, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
      ...
      var E3 = ie(p3, d2);
      return b2 && (E3 += " " + b2), v2.className && (E3 += " " + v2.className), S3[L(g3) && !A.has(g3) ? "class" : "className"] = E3, S3.ref = s3, u(g3, S3);
    }(D2, e2, r3);
  }
  O2.displayName = y2;
...
var DEFAULT_SIZE = 30;
var StyledContainer = ut.span`
  position: relative;
  width: max-content;
  font-weight: bolder;
`;
var StyledSparkleSVG = ut.svg`
  position: absolute;
  opacity: 0;
...
`;
var SparkleSVG = ({ size, timeout = 1e3 }) => {
  const [showSparkle, setShowSparkle] = useState2(false);
  const [color, setColor] = useState2("#8BE9FD");
