...
var ReactSparklyText_exports = {};
__export(ReactSparklyText_exports, {
  ReactSparklyText: () => ReactSparklyText
});
module.exports = __toCommonJS(ReactSparklyText_exports);
...
function Le(e) {
  ...
  return import_react.default.createElement(Me.Provider, { value: d }, import_react.default.createElement($e.Provider, { value: u2 }, e.children));
}
var Ge = function() {
  function e(e2, t) {
    var n = this;
...
var useReducedMotion = () => {
  const [isReducedMotionEnabled, setIsReducedMotionEnabled] = (0, import_react2.useState)(false);
...
var SparkleSVG = ({ size, timeout = 1e3 }) => {
  const [showSparkle, setShowSparkle] = (0, import_react3.useState)(false);
  const [color, setColor] = (0, import_react3.useState)("#8BE9FD");
